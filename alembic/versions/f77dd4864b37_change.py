...
Revision ID: f77dd4864b37
Revises:
Create Date: 2024-10-12 16:19:36.299496
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("exif_tool", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column("composite", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
