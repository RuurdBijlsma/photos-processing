...
from photos.server.routers.images.images_model import scroll_down, scroll_up, at_date

images_router = APIRouter(prefix="/images", tags=["images"])


@images_router.get("/at-date", response_model=list[GridImageInfo])
...
@images_router.get("/scroll-up", response_model=list[GridImageInfo])
...
@images_router.get("/scroll-down", response_model=list[GridImageInfo])
