...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('images', sa.Column('hash', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.alter_column('images', 'id',
    ...
    sa.ForeignKeyConstraint(['image_id'], ['images.id'], name='thumbnails_image_id_fkey'),
